...
module Vimus.Widget.HelpWidget (
  makeHelpWidget
...
import           Vimus.Type
import           Vimus.Command.Help hiding (help)
import           Vimus.Command.Core (Command, commandName, commandSynopsis)
import           Vimus.Command.Type (commandHelp_)
import           Vimus.Widget.ListWidget (ListWidget)
import qualified Vimus.Widget.ListWidget as ListWidget
import           Vimus.Widget.TextWidget
